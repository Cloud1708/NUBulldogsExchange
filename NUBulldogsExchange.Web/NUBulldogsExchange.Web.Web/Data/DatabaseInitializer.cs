...
public static class DatabaseInitializer
{
    ...
    private static async Task SeedSystemSettingsAsync(SqliteConnection connection)
    {
        var defaults = new (string Key, string Value, string Description)[]
        {
            ...
            ("PickupLocation", "NU Manila Merchandise Center", "Campus pickup location"),
            ("PickupInstructions", "Building A, Ground Floor. Weekdays 8:00 AM–5:00 PM.", "Pickup instructions"),
